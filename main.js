...
function modelLoaded() {
    console.log("model has been loaded yay enjoy my website")
...
function draw() {
    ...
    if(rightWristY >0 && rightWristY<= 100) {
        ...
        document.getElementById("speed").innerHTML = "Speed = 1.5 (a little fast)";
        song.rate(1.5);
    } else if (rightWristY > 300 && rightWristY <=400) {
        document.getElementById("speed").innerHTML = "Speed = 2 (double (fast))";
        song.rate(2);
...
function gotPoses(results) {
    if(results.length >0) {
        ...
        //console.log("scoreleft wrist is equal to "+ scoreLeftWrist);
